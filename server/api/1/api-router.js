...
apiRouter.get('/auth/elance', passport.authenticate('elance'));
apiRouter.get('/auth/odesk', passport.authenticate('odesk'));
...
apiRouter.get('/auth/elance/callback', 
  passport.authenticate('elance', { successRedirect: '/about',
                                      failureRedirect: '/contact' }));
apiRouter.get('/auth/odesk/callback', 
  passport.authenticate('odesk', { successRedirect: '/about',
                                      failureRedirect: '/contact' }));
